...
{
   private com.caverock.androidsvg1.SVG svg = null;
   private com.caverock.androidsvg1.RenderOptions renderOptions = new RenderOptions();
   ...
   private void  init(AttributeSet attrs, int defStyle)
   {
      ...
      TypedArray a = getContext().getTheme()
                     .obtainStyledAttributes(attrs, com.caverock.androidsvg.R.styleable.SVGImageView, defStyle, 0);
      try
      {
         // Check for css attribute
         String  css = a.getString(com.caverock.androidsvg.R.styleable.SVGImageView_css);
         if (css != null)
            renderOptions.css(css);

         // Check whether svg attribute is a resourceId
         int  resourceId = a.getResourceId(com.caverock.androidsvg.R.styleable.SVGImageView_svg, -1);
         if (resourceId != -1) {
         ...
         String  url = a.getString(com.caverock.androidsvg.R.styleable.SVGImageView_svg);
         if (url != null)
         {
    ...
    * @since 1.2.1
    */
   public void  setSVG(com.caverock.androidsvg1.SVG svg)
   {
      if (svg == null)
    ...
    * @since 1.3
    */
   public void  setSVG(com.caverock.androidsvg1.SVG svg, String css)
   {
      if (svg == null)
         throw new IllegalArgumentException("Null value passed to setSVG()");
   ...
   {
      try {
         this.svg = com.caverock.androidsvg1.SVG.getFromString(url);
         doRender();
      } catch (com.caverock.androidsvg1.SVGParseException e) {
   ...
   private class LoadResourceTask extends AsyncTask<Integer, Integer, com.caverock.androidsvg1.SVG>
   {
      ...
      protected com.caverock.androidsvg1.SVG doInBackground(Integer... params)
      {
         try
         {
            return com.caverock.androidsvg1.SVG.getFromResource(context, resourceId);
         }
         catch (com.caverock.androidsvg1.SVGParseException e)
         {
      ...
      protected void  onPostExecute(com.caverock.androidsvg1.SVG svg)
      {
   ...
   private class LoadURITask extends AsyncTask<InputStream, Integer, com.caverock.androidsvg1.SVG>
   {
      protected com.caverock.androidsvg1.SVG doInBackground(InputStream... is)
      {
         try
         {
            return com.caverock.androidsvg1.SVG.getFromInputStream(is[0]);
         }

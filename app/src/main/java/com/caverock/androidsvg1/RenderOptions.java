 ...
 * {@link com.caverock.androidsvg1.SVG#renderToCanvas(Canvas, RenderOptions)} and {@link com.caverock.androidsvg1.SVG#renderToPicture(int,int, RenderOptions)} methods.
 *
 * <h3>Example usage</h3>
 *
...
public class RenderOptions
{
   ...
   com.caverock.androidsvg1.SVG.Box viewBox = null;
   String               viewId = null;
   com.caverock.androidsvg1.SVG.Box viewPort = null;
   ...
   {
      this.viewBox = new com.caverock.androidsvg1.SVG.Box(minX, minY, width, height);
      return this;
   }

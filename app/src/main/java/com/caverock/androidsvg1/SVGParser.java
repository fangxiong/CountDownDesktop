...
import com.caverock.androidsvg1.CSSParser.CSSTextScanner;
import com.caverock.androidsvg1.CSSParser.MediaType;
import com.caverock.androidsvg1.SVG.Box;
import com.caverock.androidsvg1.SVG.CSSClipRect;
...
import com.caverock.androidsvg1.SVG.Style.TextDirection;
...
import com.caverock.androidsvg1.SVG.TextChild;
import com.caverock.androidsvg1.SVG.TextPositionedContainer;
import com.caverock.androidsvg1.SVG.TextRoot;
...
class SVGParser
{
   ...
   // SVG parser
   private com.caverock.androidsvg1.SVG svgDocument = null;
   private com.caverock.androidsvg1.SVG.SvgContainer currentElement = null;
   ...
   private static class FontWeightKeywords {
      ...
      static {
         fontWeightKeywords.put("normal", com.caverock.androidsvg1.SVG.Style.FONT_WEIGHT_NORMAL);
         fontWeightKeywords.put("bold", com.caverock.androidsvg1.SVG.Style.FONT_WEIGHT_BOLD);
         fontWeightKeywords.put("bolder", com.caverock.androidsvg1.SVG.Style.FONT_WEIGHT_BOLDER);
         fontWeightKeywords.put("lighter", com.caverock.androidsvg1.SVG.Style.FONT_WEIGHT_LIGHTER);
   ...
   private static class AspectRatioKeywords {
      private static final Map<String, com.caverock.androidsvg1.PreserveAspectRatio.Alignment> aspectRatioKeywords = new HashMap<>(10);
      static {
         aspectRatioKeywords.put(NONE, com.caverock.androidsvg1.PreserveAspectRatio.Alignment.none);
         aspectRatioKeywords.put("xMinYMin", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMinYMin);
         aspectRatioKeywords.put("xMidYMin", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMidYMin);
         aspectRatioKeywords.put("xMaxYMin", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMaxYMin);
         aspectRatioKeywords.put("xMinYMid", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMinYMid);
         aspectRatioKeywords.put("xMidYMid", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMidYMid);
         aspectRatioKeywords.put("xMaxYMid", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMaxYMid);
         aspectRatioKeywords.put("xMinYMax", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMinYMax);
         aspectRatioKeywords.put("xMidYMax", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMidYMax);
         aspectRatioKeywords.put("xMaxYMax", com.caverock.androidsvg1.PreserveAspectRatio.Alignment.xMaxYMax);
      }

      static com.caverock.androidsvg1.PreserveAspectRatio.Alignment get(String aspectRatio) {
   ...
   com.caverock.androidsvg1.SVG parse(InputStream is, boolean enableInternalEntities) throws SVGParseException
   {
   ...
   {
      SVGParser.this.svgDocument = new com.caverock.androidsvg1.SVG();
   }
   ...
   private void  text(String characters) throws SVGParseException
   {
      ...
      else if (currentElement instanceof com.caverock.androidsvg1.SVG.TextContainer)
      {
   ...
   private void  appendToTextContainer(String characters) throws SVGParseException
   {
      ...
      com.caverock.androidsvg1.SVG.SvgConditionalContainer parent = (com.caverock.androidsvg1.SVG.SvgConditionalContainer) currentElement;
      int  numOlderSiblings = parent.children.size();
      com.caverock.androidsvg1.SVG.SvgObject previousSibling = (numOlderSiblings == 0) ? null : parent.children.get(numOlderSiblings-1);
      if (previousSibling instanceof com.caverock.androidsvg1.SVG.TextSequence) {
         // Last sibling was a TextSequence also, so merge them.
         ((com.caverock.androidsvg1.SVG.TextSequence) previousSibling).text += characters;
      } else {
         // Add a new TextSequence to the child node list
         currentElement.addChild(new com.caverock.androidsvg1.SVG.TextSequence( characters ));
      }
   }
   ...
   {
      if (instruction.equals(XML_STYLESHEET_PROCESSING_INSTRUCTION) && com.caverock.androidsvg1.SVG.getFileResolver() != null)
      {
         // If a "type" is specified, make sure it is the CSS type
         String  attr = attributes.get(XML_STYLESHEET_ATTR_TYPE);
         if (attr != null && !com.caverock.androidsvg1.CSSParser.CSS_MIME_TYPE.equals(attributes.get("type")))
            return;
         ...
         if (attr != null)
         {
            String  css = com.caverock.androidsvg1.SVG.getFileResolver().resolveCSSStyleSheet(attr);
            if (css == null)
               return;
   ...
   private void  dumpNode(com.caverock.androidsvg1.SVG.SvgObject elem, String indent)
   {
      Log.d(TAG, indent+elem);
      if (elem instanceof com.caverock.androidsvg1.SVG.SvgConditionalContainer) {
         indent = indent+"  ";
         for (com.caverock.androidsvg1.SVG.SvgObject child: ((com.caverock.androidsvg1.SVG.SvgConditionalContainer) elem).children) {
   ...
   private void  svg(Attributes attributes) throws SVGParseException
   {
      ...
      com.caverock.androidsvg1.SVG.Svg obj = new com.caverock.androidsvg1.SVG.Svg();
   ...
   private void  parseAttributesSVG(com.caverock.androidsvg1.SVG.Svg obj, Attributes attributes) throws SVGParseException
   {
   ...
   private void  g(Attributes attributes) throws SVGParseException
   {
      ...
      com.caverock.androidsvg1.SVG.Group obj = new com.caverock.androidsvg1.SVG.Group();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  defs(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Defs obj = new com.caverock.androidsvg1.SVG.Defs();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  a(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.A  obj = new com.caverock.androidsvg1.SVG.A();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesA(com.caverock.androidsvg1.SVG.A obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  use(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Use obj = new com.caverock.androidsvg1.SVG.Use();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesUse(com.caverock.androidsvg1.SVG.Use obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  image(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Image obj = new com.caverock.androidsvg1.SVG.Image();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesImage(com.caverock.androidsvg1.SVG.Image obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  path(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Path obj = new com.caverock.androidsvg1.SVG.Path();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesPath(com.caverock.androidsvg1.SVG.Path obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  rect(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Rect obj = new com.caverock.androidsvg1.SVG.Rect();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesRect(com.caverock.androidsvg1.SVG.Rect obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  circle(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Circle obj = new com.caverock.androidsvg1.SVG.Circle();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesCircle(com.caverock.androidsvg1.SVG.Circle obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  ellipse(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Ellipse obj = new com.caverock.androidsvg1.SVG.Ellipse();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesEllipse(com.caverock.androidsvg1.SVG.Ellipse obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  line(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Line obj = new com.caverock.androidsvg1.SVG.Line();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesLine(com.caverock.androidsvg1.SVG.Line obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  polyline(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.PolyLine obj = new com.caverock.androidsvg1.SVG.PolyLine();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
    ...
    */
   private void  parseAttributesPolyLine(com.caverock.androidsvg1.SVG.PolyLine obj, Attributes attributes, String tag) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
   ...
   private void  polygon(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Polygon obj = new com.caverock.androidsvg1.SVG.Polygon();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  text(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Text obj = new com.caverock.androidsvg1.SVG.Text();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  tspan(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      if (!(currentElement instanceof com.caverock.androidsvg1.SVG.TextContainer))
         throw new SVGParseException("Invalid document. <tspan> elements are only valid inside <text> or other <tspan> elements.");
      com.caverock.androidsvg1.SVG.TSpan obj = new com.caverock.androidsvg1.SVG.TSpan();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  tref(Attributes attributes) throws SVGParseException
   {
      ...
      com.caverock.androidsvg1.SVG.TRef obj = new com.caverock.androidsvg1.SVG.TRef();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesTRef(com.caverock.androidsvg1.SVG.TRef obj, Attributes attributes)
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  zwitch(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Switch obj = new com.caverock.androidsvg1.SVG.Switch();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesConditional(com.caverock.androidsvg1.SVG.SvgConditional obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  symbol(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Symbol obj = new com.caverock.androidsvg1.SVG.Symbol();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  marker(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Marker obj = new com.caverock.androidsvg1.SVG.Marker();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesMarker(com.caverock.androidsvg1.SVG.Marker obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  linearGradient(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.SvgLinearGradient obj = new com.caverock.androidsvg1.SVG.SvgLinearGradient();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesGradient(com.caverock.androidsvg1.SVG.GradientElement obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  parseAttributesLinearGradient(com.caverock.androidsvg1.SVG.SvgLinearGradient obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  radialGradient(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.SvgRadialGradient obj = new com.caverock.androidsvg1.SVG.SvgRadialGradient();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesRadialGradient(com.caverock.androidsvg1.SVG.SvgRadialGradient obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  stop(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      if (!(currentElement instanceof com.caverock.androidsvg1.SVG.GradientElement))
         throw new SVGParseException("Invalid document. <stop> elements are only valid inside <linearGradient> or <radialGradient> elements.");
      com.caverock.androidsvg1.SVG.Stop obj = new com.caverock.androidsvg1.SVG.Stop();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesStop(com.caverock.androidsvg1.SVG.Stop obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  solidColor(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.SolidColor obj = new com.caverock.androidsvg1.SVG.SolidColor();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  clipPath(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.ClipPath obj = new com.caverock.androidsvg1.SVG.ClipPath();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesClipPath(com.caverock.androidsvg1.SVG.ClipPath obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void textPath(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.TextPath obj = new com.caverock.androidsvg1.SVG.TextPath();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesTextPath(com.caverock.androidsvg1.SVG.TextPath obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void pattern(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Pattern obj = new com.caverock.androidsvg1.SVG.Pattern();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesPattern(com.caverock.androidsvg1.SVG.Pattern obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  view(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.View obj = new com.caverock.androidsvg1.SVG.View();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesConditional(obj, attributes);
   ...
   private void mask(Attributes attributes) throws SVGParseException
   {
      ...
      if (currentElement == null)
         throw new SVGParseException("Invalid document. Root element must be <svg>");
      com.caverock.androidsvg1.SVG.Mask obj = new com.caverock.androidsvg1.SVG.Mask();
      obj.document = svgDocument;
      obj.parent = currentElement;
      parseAttributesCore(obj, attributes);
      parseAttributesStyle(obj, attributes);
   ...
   private void  parseAttributesMask(com.caverock.androidsvg1.SVG.Mask obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   static class TextScanner
   {
      ...
      private com.caverock.androidsvg1.NumberParser numberParser = new com.caverock.androidsvg1.NumberParser();
   ...
   private void  parseAttributesStyle(SvgElementBase obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         ...
         switch (SVGAttr.fromString(attributes.getLocalName(i)))
         {
            ...
            case CLASS:
               obj.classNames = com.caverock.androidsvg1.CSSParser.parseClassAttribute(val);
               break;
   ...
   static void  processStyleProperty(Style style, String localName, String val)// throws SVGParseException
   {
      ...
      switch (SVGAttr.fromString(localName))
      {
         case fill:
            ...
            if (style.fill != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_FILL;
            break;

         case fill_rule:
            style.fillRule = parseFillRule(val);
            if (style.fillRule != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_FILL_RULE;
            break;

         case fill_opacity:
            style.fillOpacity = parseOpacity(val);
            if (style.fillOpacity != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_FILL_OPACITY;
            break;

         case stroke:
            style.stroke = parsePaintSpecifier(val);
            if (style.stroke != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE;
            break;

         case stroke_opacity:
            style.strokeOpacity = parseOpacity(val);
            if (style.strokeOpacity != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE_OPACITY;
            break;

         case stroke_width:
            try {
               style.strokeWidth = parseLength(val);
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE_WIDTH;
         ...
         case stroke_linecap:
            ...
            if (style.strokeLineCap != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE_LINECAP;
            break;

         case stroke_linejoin:
            style.strokeLineJoin = parseStrokeLineJoin(val);
            if (style.strokeLineJoin != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE_LINEJOIN;
            break;

         case stroke_miterlimit:
            try {
               style.strokeMiterLimit = parseFloat(val);
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE_MITERLIMIT;
            } catch (SVGParseException e) {
               // Do nothing
            }
            break;
         ...
         case stroke_dasharray:
            if (NONE.equals(val)) {
               ...
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE_DASHARRAY;
               break;
            }
         ...
         case stroke_dashoffset:
            try {
               ...
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STROKE_DASHOFFSET;
            } catch (SVGParseException e) {
               // Do nothing
            }
            break;
         ...
         case opacity:
            ...
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_OPACITY;
            break;

         case color:
            try {
               style.color = parseColour(val);
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_COLOR;
            } catch (SVGParseException e) {
               // Do nothing
            }
            break;
         ...
         case font_family:
            ...
            if (style.fontFamily != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_FONT_FAMILY;
            break;

         case font_size:
            style.fontSize = parseFontSize(val);
            if (style.fontSize != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_FONT_SIZE;
            break;

         case font_weight:
            style.fontWeight = parseFontWeight(val);
            if (style.fontWeight != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_FONT_WEIGHT;
            break;

         case font_style:
            style.fontStyle = parseFontStyle(val);
            if (style.fontStyle != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_FONT_STYLE;
            break;

         case text_decoration:
            style.textDecoration = parseTextDecoration(val);
            if (style.textDecoration != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_TEXT_DECORATION;
            break;

         case direction:
            style.direction = parseTextDirection(val);
            if (style.direction != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_DIRECTION;
            break;

         case text_anchor:
            style.textAnchor = parseTextAnchor(val);
            if (style.textAnchor != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_TEXT_ANCHOR;
            break;

         case overflow:
            style.overflow = parseOverflow(val);
            if (style.overflow != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_OVERFLOW;
            break;
         ...
         case marker:
            ...
            style.specifiedFlags |= (com.caverock.androidsvg1.SVG.SPECIFIED_MARKER_START | com.caverock.androidsvg1.SVG.SPECIFIED_MARKER_MID | com.caverock.androidsvg1.SVG.SPECIFIED_MARKER_END);
            break;

         case marker_start:
            style.markerStart = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_MARKER_START;
            break;

         case marker_mid:
            style.markerMid = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_MARKER_MID;
            break;

         case marker_end:
            style.markerEnd = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_MARKER_END;
            break;
         ...
         case display:
            ...
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_DISPLAY;
            break;
         ...
         case visibility:
            ...
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_VISIBILITY;
            break;
         ...
         case stop_color:
            ...
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STOP_COLOR;
            break;

         case stop_opacity:
            style.stopOpacity = parseOpacity(val);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_STOP_OPACITY;
            break;

         case clip:
            style.clip = parseClip(val);
            if (style.clip != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_CLIP;
            break;

         case clip_path:
            style.clipPath = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_CLIP_PATH;
            break;

         case clip_rule:
            style.clipRule = parseFillRule(val);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_CLIP_RULE;
            break;

         case mask:
            style.mask = parseFunctionalIRI(val, localName);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_MASK;
            break;
         ...
         case solid_color:
            ...
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_SOLID_COLOR;
            break;

         case solid_opacity:
            style.solidOpacity = parseOpacity(val);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_SOLID_OPACITY;
            break;
         ...
         case viewport_fill:
            ...
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_VIEWPORT_FILL;
            break;

         case viewport_fill_opacity:
            style.viewportFillOpacity = parseOpacity(val);
            style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_VIEWPORT_FILL_OPACITY;
            break;

         case vector_effect:
            style.vectorEffect = parseVectorEffect(val);
            if (style.vectorEffect != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_VECTOR_EFFECT;
            break;

         case image_rendering:
            style.imageRendering = parseRenderQuality(val);
            if (style.imageRendering != null)
               style.specifiedFlags |= com.caverock.androidsvg1.SVG.SPECIFIED_IMAGE_RENDERING;
            break;
   ...
   private void  parseAttributesViewBox(com.caverock.androidsvg1.SVG.SvgViewBoxContainer obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
         String val = attributes.getValue(i).trim();
   ...
   private void  parseAttributesTransform(com.caverock.androidsvg1.SVG.HasTransform obj, Attributes attributes) throws SVGParseException
   {
      for (int i=0; i<attributes.getLength(); i++)
      {
   ...
   {
      com.caverock.androidsvg1.NumberParser np = new com.caverock.androidsvg1.NumberParser();
   ...
   private static Box parseViewBox(String val) throws SVGParseException
   {
      ...
      return new com.caverock.androidsvg1.SVG.Box(minX, minY, width, height);
   }
    ...
    */
   private static void  parsePreserveAspectRatio(com.caverock.androidsvg1.SVG.SvgPreserveAspectRatioContainer obj, String val) throws SVGParseException
   {
      obj.preserveAspectRatio = parsePreserveAspectRatio(val);
   }


   static com.caverock.androidsvg1.PreserveAspectRatio parsePreserveAspectRatio(String val) throws SVGParseException
   {
      TextScanner scan = new TextScanner(val);
      scan.skipWhitespace();
      ...
      com.caverock.androidsvg1.PreserveAspectRatio.Alignment align = AspectRatioKeywords.get(word);
      com.caverock.androidsvg1.PreserveAspectRatio.Scale scale = null;
      ...
      if (!scan.empty()) {
         ...
         switch (meetOrSlice) {
            case "meet":
               scale = com.caverock.androidsvg1.PreserveAspectRatio.Scale.meet; break;
            case "slice":
               scale = com.caverock.androidsvg1.PreserveAspectRatio.Scale.slice; break;
            default:
   ...
   private static Colour parseColour(String val) throws SVGParseException
   {
      if (val.charAt(0) == '#')
      {
         com.caverock.androidsvg1.IntegerParser ip = com.caverock.androidsvg1.IntegerParser.parseHex(val, 1, val.length());
         if (ip == null) {
   ...
   private static void  parseFont(Style style, String val)
   {
      ...
      style.specifiedFlags |= (com.caverock.androidsvg1.SVG.SPECIFIED_FONT_FAMILY | com.caverock.androidsvg1.SVG.SPECIFIED_FONT_SIZE | com.caverock.androidsvg1.SVG.SPECIFIED_FONT_WEIGHT | com.caverock.androidsvg1.SVG.SPECIFIED_FONT_STYLE);
   }
   ...
   protected static com.caverock.androidsvg1.SVG.PathDefinition parsePath(String val)
   {
      TextScanner  scan = new TextScanner(val);
      ...
      com.caverock.androidsvg1.SVG.PathDefinition path = new SVG.PathDefinition();
   ...
   private void  style(Attributes attributes) throws SVGParseException
   {
      ...
      for (int i=0; i<attributes.getLength(); i++)
      {
         ...
         {
            case type:
               isTextCSS = val.equals(com.caverock.androidsvg1.CSSParser.CSS_MIME_TYPE);
               break;
            case media:
               media = val;
               break;
      ...
      if (isTextCSS && com.caverock.androidsvg1.CSSParser.mediaMatches(media, MediaType.screen)) {
         inStyleElement = true;
      } else {
         ignoring = true;
         ignoreDepth = 1;
   ...
   {
      com.caverock.androidsvg1.CSSParser cssp = new com.caverock.androidsvg1.CSSParser(MediaType.screen, com.caverock.androidsvg1.CSSParser.Source.Document);

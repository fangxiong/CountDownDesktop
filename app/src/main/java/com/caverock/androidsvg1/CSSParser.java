...
class CSSParser
{
   ...
   static class  Rule
   {
      ...
      com.caverock.androidsvg1.SVG.Style style = null;
      Source     source;
      
      Rule(Selector selector, com.caverock.androidsvg1.SVG.Style style, Source source)
      {
   ...
   */
   ...
   static class CSSTextScanner extends SVGParser.TextScanner
   {
       ...
       */
      private List<Selector>  nextSelectorGroup() throws com.caverock.androidsvg1.CSSParseException
      {
         if (empty())
            return null;
       ...
       */
      boolean  nextSimpleSelector(Selector selector) throws com.caverock.androidsvg1.CSSParseException
      {
         if (empty())
            return false;
         ...
         while (!empty())
         {
            if (consume('.'))
            {
               ...
               if (value == null)
                  throw new com.caverock.androidsvg1.CSSParseException("Invalid \".class\" simpleSelectors");
            ...
            if (consume('#'))
            {
               ...
               String  value = nextIdentifier();
               if (value == null)
                  throw new com.caverock.androidsvg1.CSSParseException("Invalid \"#id\" simpleSelectors");
            ...
            if (consume('['))
            {
               ...
               if (attrName == null)
                  throw new com.caverock.androidsvg1.CSSParseException("Invalid attribute simpleSelectors");
               skipWhitespace();
               AttribOp  op = null;
               if (consume('='))
                  op = AttribOp.EQUALS;
      ...
      private AnPlusB  nextAnPlusB() throws com.caverock.androidsvg1.CSSParseException
      {
         if (empty())
            return null;
         ...
         else
         {
            ...
            // Then an integer
            com.caverock.androidsvg1.IntegerParser a = null,
                           b = com.caverock.androidsvg1.IntegerParser.parseInt(input, position, inputLength, false);
            if (b != null)
               position = b.getEndPos();
            // If an 'n' is next then that last part was the 'a' part. Now check for the 'b' part.
            if (consume('n') || consume('N')) {
               a = (b != null) ? b : new com.caverock.androidsvg1.IntegerParser(1, position);
               aSign = bSign;
               b = null;
               bSign = 1;
               skipWhitespace();
       ...
       * Eg. for :lang(en)
       */
      private List<String>  nextIdentListParam() throws com.caverock.androidsvg1.CSSParseException
      {
         if (empty())
            return null;
       ...
       */
      private List<Selector>  nextPseudoNotParam() throws com.caverock.androidsvg1.CSSParseException
      {
         if (empty())
            return null;
       ...
       */
      private void  parsePseudoClass(Selector selector, SimpleSelector selectorPart) throws com.caverock.androidsvg1.CSSParseException
      {
         // skip pseudo
//         int     pseudoStart = position;
         String  ident = nextIdentifier();
         if (ident == null)
            throw new com.caverock.androidsvg1.CSSParseException("Invalid pseudo class");
         ...
         switch (identEnum)
         {
            ...
            case nth_last_of_type:
               ...
               if (ab == null)
                  throw new com.caverock.androidsvg1.CSSParseException("Invalid or missing parameter section for pseudo class: " + ident);
            ...
            default:
               throw new com.caverock.androidsvg1.CSSParseException("Unsupported pseudo class: " + ident);
         }
...
//         simpleSelectors.addedAttributeOrPseudo();
   ...
   private void  parseAtRule(Ruleset ruleset, CSSTextScanner scan) throws com.caverock.androidsvg1.CSSParseException
   {
      String  atKeyword = scan.nextIdentifier();
      scan.skipWhitespace();
      if (atKeyword == null)
         throw new com.caverock.androidsvg1.CSSParseException("Invalid '@' rule");
      if (!inMediaRule && atKeyword.equals("media"))
      {
         List<MediaType>  mediaList = parseMediaList(scan);
         if (!scan.consume('{'))
            throw new com.caverock.androidsvg1.CSSParseException("Invalid @media rule: missing rule set");
         ...
         if (!scan.empty() && !scan.consume('}'))
            throw new com.caverock.androidsvg1.CSSParseException("Invalid @media rule: expected '}' at end of rule set");
      ...
      else if (!inMediaRule && atKeyword.equals("import"))
      {
         ...
         if (file == null)
            throw new com.caverock.androidsvg1.CSSParseException("Invalid @import rule: expected string or url()");
         ...
         if (com.caverock.androidsvg1.SVG.getFileResolver() != null && mediaMatches(mediaList, deviceMediaType)) {
            String  css = com.caverock.androidsvg1.SVG.getFileResolver().resolveCSSStyleSheet(file);
            if (css == null)
               return;
   ...
   private Ruleset  parseRuleset(CSSTextScanner scan)
   {
      ...
      catch (com.caverock.androidsvg1.CSSParseException e)
      {
   ...
   private boolean  parseRule(Ruleset ruleset, CSSTextScanner scan) throws com.caverock.androidsvg1.CSSParseException
   {
      List<Selector>  selectors = scan.nextSelectorGroup();
      if (selectors != null && !selectors.isEmpty())
      {
         if (!scan.consume('{'))
            throw new com.caverock.androidsvg1.CSSParseException("Malformed rule block: expected '{'");
         scan.skipWhitespace();
         com.caverock.androidsvg1.SVG.Style ruleStyle = parseDeclarations(scan);
         scan.skipWhitespace();
   ...
   private com.caverock.androidsvg1.SVG.Style parseDeclarations(CSSTextScanner scan) throws com.caverock.androidsvg1.CSSParseException
   {
      com.caverock.androidsvg1.SVG.Style ruleStyle = new SVG.Style();
      while (true)
      {
         String  propertyName = scan.nextIdentifier();
         scan.skipWhitespace();
         if (!scan.consume(':'))
            throw new com.caverock.androidsvg1.CSSParseException("Expected ':'");
         scan.skipWhitespace();
         String  propertyValue = scan.nextPropertyValue();
         if (propertyValue == null)
            throw new com.caverock.androidsvg1.CSSParseException("Expected property value");
         // Check for !important flag.
         scan.skipWhitespace();
         if (scan.consume('!')) {
            scan.skipWhitespace();
            if (!scan.consume("important")) {
               throw new com.caverock.androidsvg1.CSSParseException("Malformed rule set: found unexpected '!'");
            }

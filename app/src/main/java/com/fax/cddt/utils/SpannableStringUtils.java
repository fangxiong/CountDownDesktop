...
public class SpannableStringUtils {
    ...
    public static class Builder {
        ...
        public Builder setFontTypeface(@Nullable Typeface typeface) {
        ...
        /**
         * 设置点击事件
         * <p>需添加view.setMovementMethod(LinkMovementMethod.newInstance())</p>
         *
        ...
        private void setSpan() {
            ...
            if (typeface != null) {
                mBuilder.setSpan(new MyTypefaceSpan(typeface), start, end, flag);
                typeface = null;
            }
            if (align != null) {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(AppContext.get(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(AppContext.get(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    ...
                    ImageSpan imageSpan = new CenterImageSpan(drawable, ImageSpan.ALIGN_BASELINE);

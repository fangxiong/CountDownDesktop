...
import com.fax.cddt.view.timepickdialog.adapter.NumericWheelAdapter;
import com.fax.cddt.view.timepickdialog.lib.WheelView;
import com.fax.cddt.view.timepickdialog.listener.OnItemSelectedListener;
...
public class WheelTime{
	...
	public void setPicker(int year , final int month , int day, int h, int m) {
		...
		OnItemSelectedListener whellListener_day = new OnItemSelectedListener() {
			@Override
			public void onItemSelected(int index) {
				setTimeChangeListener();
			}
		...
		wv_day.setOnItemSelectedListener(whellListener_day);
	...
	private void setTimeChangeListener(){
		if (mTimeChangeListener != null){
			mTimeChangeListener.onTimeChanged(getTime());
		}
	}

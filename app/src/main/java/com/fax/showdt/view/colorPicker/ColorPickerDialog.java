...
package com.fax.showdt.view.colorPicker;
...
public class ColorPickerDialog extends DialogFragment implements ColorPickerView.OnColorChangedListener, TextWatcher {
    ...
    LinearLayout shadesLayout, latestColorLayout,ll_latest_color;
    BubbleSeekBar transparencySeekBar;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(requireActivity(), R.style.ColorPickDialogTheme).setView(rootView)
    ...
    View createPresetsView() {
        ...
        latestColorLayout = (LinearLayout) contentView.findViewById(R.id.latest_color);
        ll_latest_color = (LinearLayout) contentView.findViewById(R.id.ll_latest_color);
        transparencySeekBar = (BubbleSeekBar) contentView.findViewById(R.id.transparency_seekbar);
        ...
        if (showColorShades) {
            ...
            latestColorLayout.setVisibility(View.GONE);
            contentView.findViewById(R.id.shades_divider).setVisibility(View.GONE);
        }

        int[] colors = ConfigManager.getMainConfig().getIntArray("latest_color",new int[]{});
        if(colors.length == 0){
            ll_latest_color.setVisibility(View.GONE);
        }else {
            createLatestColorShades();
        }
    ...
    void createLatestColorShades() {
        ...
        for(final int color:colors) {
            ...
            latestColorLayout.addView(view);
    ...
    private void addLatestColor(int color) {
        int[] colors = ConfigManager.getMainConfig().getIntArray("latest_color", new int[]{});
        ...
        ConfigManager.getMainConfig().putIntArray("latest_color",result);
    }
...
//    transparencySeekBar.setMax(255);
        ...
        transparencySeekBar.setOnProgressChangedListener(new BubbleSeekBar.OnProgressChangedListener() {
            @Override

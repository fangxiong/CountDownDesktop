package com.fax.showdt.dialog.ios.util.view;
...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_sl_shadowColor, getResources().getColor(R.color.c_4D000000));
        } finally {
            attr.recycle();
        }
    }
